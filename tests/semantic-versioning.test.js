...
function determineVersionIncrement(changes) {
  ...
  for (const change of changes) {
    if (change.type === 'deleted') {
      ...
      const beforeMap = new Map(before.map(token => [`${token.address}-${token.chainId || 'undefined'}`, token]))
      const afterMap = new Map(after.map(token => [`${token.address}-${token.chainId || 'undefined'}`, token]))
      ...
      for (const [key, beforeToken] of beforeMap) {
        ...
        if (afterToken) {
          ...
          if (beforeToken.address !== afterToken.address || beforeToken.chainId !== afterToken.chainId) {
            hasMajorChange = true
            break
          }
...
const testCases = [
  // MAJOR VERSION TESTS
  {
    ...
    changes: [{
      ...
      type: "modified",
      before: [
        { address: "0x123", symbol: "TEST", name: "Test", decimals: 18, logoURI: "test.png" },
        { address: "0x456", symbol: "OLD", name: "Old Token", decimals: 18, logoURI: "old.png" }
      ],
      after: [
        { address: "0x123", symbol: "TEST", name: "Test", decimals: 18, logoURI: "test.png" }
      ]
  ...
  },
  {
    ...
    changes: [{
      ...
      after: [
        { address: "0x456", symbol: "TEST", name: "Test", decimals: 18, logoURI: "test.png" }
      ]
    }],
    expected: "major"
  },
  {
    ...
    changes: [{
      ...
      type: "modified", 
      before: [
        { address: "0x123", chainId: 1, symbol: "TEST", name: "Test", decimals: 18, logoURI: "test.png" }
      ],
      after: [
        { address: "0x123", chainId: 137, symbol: "TEST", name: "Test", decimals: 18, logoURI: "test.png" }
      ]
    }],
    expected: "major"
  },
  ...
  // MINOR VERSION TESTS  
  {
    ...
    changes: [{
      ...
      after: [
        { address: "0x123", symbol: "TEST", name: "Test", decimals: 18, logoURI: "test.png" },
        { address: "0x456", symbol: "NEW", name: "New Token", decimals: 18, logoURI: "new.png" }
      ]
    }],
    expected: "minor"
  },
  ...
  // PATCH VERSION TESTS
  {
    ...
    changes: [{
      ...
      after: [
        { address: "0x123", symbol: "TEST", name: "Test Updated", decimals: 18, logoURI: "test.png" }
      ]
    }],
    expected: "patch"
  },
  {
    ...
    changes: [{
      ...
      after: [
        { address: "0x123", symbol: "TST", name: "Test", decimals: 18, logoURI: "test.png" }
      ]
    }],
    expected: "patch"
  },
  {
    ...
    changes: [{
      ...
      type: "modified",
      before: [
        { address: "0x123", symbol: "TEST", name: "Test", decimals: 18, logoURI: "old.png" }
      ],
      after: [
        { address: "0x123", symbol: "TEST", name: "Test", decimals: 18, logoURI: "new.png" }
      ]
    }],
    expected: "patch"
  },
  {
    ...
    changes: [{
      ...
      after: [
        { address: "0x123", symbol: "TEST", name: "Test", decimals: 6, logoURI: "test.png" }
      ]
    }],
    expected: "patch"
  },
  ...
  // NO VERSION INCREMENT TESTS
  {
    ...
    changes: [{
      ...
      type: "modified",
      before: [
        { address: "0x123", symbol: "FIRST", name: "First Token", decimals: 18, logoURI: "first.png" },
        { address: "0x456", symbol: "SECOND", name: "Second Token", decimals: 6, logoURI: "second.png" },
        { address: "0x789", symbol: "THIRD", name: "Third Token", decimals: 18, logoURI: "third.png" }
      ],
      after: [
        { address: "0x456", symbol: "SECOND", name: "Second Token", decimals: 6, logoURI: "second.png" },
        { address: "0x789", symbol: "THIRD", name: "Third Token", decimals: 18, logoURI: "third.png" },
  ...
  // MIXED SCENARIOS (highest priority wins)
  {
    ...
    changes: [{
      ...
      after: [
        { address: "0x123", symbol: "TEST", name: "Test Updated", decimals: 18, logoURI: "test.png" },
        { address: "0x789", symbol: "NEW", name: "New Token", decimals: 18, logoURI: "new.png" }
      ]
    }],
    expected: "major"
  },
...
for (const test of testCases) {
  ...
  console.log(`   Expected: ${test.expected || 'no increment'}, Got: ${result || 'no increment'}`)
